...
class FeilinformasjonTest {
    ...
    fun `kan serialisere og deserialisere`() {
        ...
        val expected = """
            [{"type":"OverlappendeBarnetrygdperioder","message":"bt","exceptionType":"et","exceptionMessage":"em","omsorgsmottaker": "om"},{"type":"OverlappendeHjelpestønadperioder","message":"hs","exceptionType":"et","exceptionMessage":"em","omsorgsmottaker": "om"},{"type":"UgyldigIdent","message":"alterum","exceptionType":"gloriatur","exceptionMessage":"hinc","ident":"cu","identRolle":"OMSORGSMOTTAKER_BARNETRYGD"},{"type":"FeilIDatagrunnlag","message":"fidg","exceptionType":"et","exceptionMessage":"em"}]
        """.trimIndent()
